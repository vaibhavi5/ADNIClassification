...
def read_X_y_5D_idx(df, idx, scorename, cr, k):
    ...
    rel_path_mIP = '/data/users2/vitkyal/projects/complex/MIP/min/minMIP_'
    ...
    fNfm = rel_path_mIP + subj_id + '_' + session + '.pt'
...
def test_saliency(cfg):
    ...
    for md in ['te']:#,'va','te']:
        ...
        for i, data in enumerate(dataloader, 0):
            ...
            input, labels = data
            inputs = addPadding(input)
            mask_path = '/data/users2/vitkyal/projects/SMLvsDL/reprex/saliency_analysis/average_smrimask64.nii'#loadMasks(cfg, md)
