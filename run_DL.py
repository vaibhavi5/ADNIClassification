...
if __name__ == '__main__':
    ...
    parser.add_argument('--k', type=int, default=0, metavar='N',
                        help='iteration to get solo sMRI and fMRI')
    ...
    parser.add_argument('--mode', default='tr', metavar='S',
                        help='train test val')
    ...
    iter = 1
    cfg = ut.Config(iter=iter, tr_smp_sizes=args.tr_smp_sizes, nReps=args.nReps, nc=args.nc, bs=args.bs, lr=args.lr, es=args.es, pp=args.pp, k=args.k,
